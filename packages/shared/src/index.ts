...
/**
 * 종합 우세 배지 팩터 임계 — wave-365 (cycle 1705), wave-368 WAR 추가 (cycle 1708), wave-379 Elo 추가 (cycle 1722), wave-381 최근폼 추가 (cycle 1723), wave-383 상대전적 추가 (cycle 1725), wave-386 선발xFIP 추가 (cycle 1729).
 * wOBA/SFR/불펜FIP/선발FIP/WAR/Elo/최근폼/상대전적/선발xFIP 9개 직접 대결 결과 집계 시
