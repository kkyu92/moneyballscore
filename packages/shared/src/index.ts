 ...
 * |compositeDuelScore| ≥ 본 값 시: analysis/page.tsx = accent(골드) 색상·amber 칩·'완전수렴' 레이블 칩 (wave-459/wave-465) + 섹션 container amber border/bg (wave-467), game/[id]/page.tsx = amber 배경 배지 + amber 칩 + 합치 칩 amber + '완전수렴' 레이블 칩 (wave-461/wave-463). false 시 상대 팀 우세 팩터 칩 표시 (wave-456).
