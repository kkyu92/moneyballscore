...
/**
 * 종합 우세 배지 팩터 임계 — wave-365 (cycle 1705), wave-368 WAR 추가 (cycle 1708), wave-379 Elo 추가 (cycle 1722), wave-381 최근폼 추가 (cycle 1723), wave-383 상대전적 추가 (cycle 1725).
 * wOBA/SFR/불펜FIP/선발FIP/WAR/Elo/최근폼/상대전적 8개 직접 대결 결과 집계 시
...
/**
 * 종합 우세 배지 최소 유효 팩터 수 — wave-365 (cycle 1705), wave-368 WAR 추가 (cycle 1708), wave-379 Elo 추가 (cycle 1722), wave-381 최근폼 추가 (cycle 1723), wave-383 상대전적 추가 (cycle 1725).
 * null pair 포함 시 집계 신뢰도 보장을 위해
 * 유효(non-null) 팩터 쌍이 본 값 미만이면 배지 표시 안 함.
 * WAR/Elo/최근폼/상대전적 4개 optional(항상 가용 X) — 4/8 이상 유효 시 집계.
 */
