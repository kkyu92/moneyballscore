 ...
 * 페이지 헤딩 / 가이드 카드 / glossary 라벨) 의 hardcoded "v1.8" string → 본 상수 참조 swap.
 * v1.8 유지 확정 (cycle 1460, 2026-07-06) — v2.1-B rejected (Brier 0.4635).
 */
 ...
 * 통합. v1.8 유지 확정 (cycle 1460) — 신규 prod era 박제 계획 없음.
 */
...
// LLM (debate / postview) 활성 라벨 단일 source. v1.8 유지 확정 (cycle 1460) —
// LLM 라벨 v2.0-debate / v2.0-postview 고정. decideModelVersion / decidePostviewModelVersion +
// telegram LLM_ACTIVE_VERSIONS + buildAccuracyData LLM_ACTIVE_VERSIONS +
// compareModels 분기 5곳 참조.
