...
#### W28 (07-06~07-12) 진행 중 업데이트 — 2026-07-08 기준

| 지표 | 수치 |
|---|---|
| 완료 경기 | 5경기 (07-07 화요일) |
| 정확도 | **40.0%** (2/5) — 주 초반 소표본 |
| CREDIT_EXHAUSTED | 계속 → conf=0.3 flat (32일+) |
| WAR/park_factor | **fix 배포** (cycle 1519) — 다음 파이프라인 fire부터 적용 |

07-07 경기 결과:
- ✓ SS 9-2 LG (삼성 예측 적중, sfr 강세)
- ✓ HH 6-9 NC (NC 예측 적중, away pick)
- ✗ LT 10-2 HT (롯데 홈 강점 미반영, hwp=0.49 박빙)
- ✗ OB 2-4 SK (OB 선발+불펜 우위 예측, SK 역전)
- ✗ KT 3-0 WO (WO 예측, KT 선발 완봉)
