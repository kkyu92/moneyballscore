...
export const alt = "MLB Postseason 브라켓 | MoneyBall Score";

export default function MlbPostseasonTwitterImage() {
  return new ImageResponse(
    (
      ...
      >
        ...
        >
          <span>moneyballscore.vercel.app/mlb/postseason</span>
          <span>KO · EN · Live ETA 2026-09</span>
        </div>
      </div>
    ),
    { ...size },
