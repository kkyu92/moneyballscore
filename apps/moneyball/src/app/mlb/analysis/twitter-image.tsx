...
export const alt = "MLB AI 분석 | MoneyBall Score";

export default function MlbAnalysisHubTwitterImage() {
  return new ImageResponse(
    (
      ...
      >
        ...
        >
          MLB 전체 경기 AI 분석 · 팩터 수렴 픽 · 오늘의 빅매치
        </div>
        ...
        >
          <span>{SITE_HOST}/mlb/analysis</span>
