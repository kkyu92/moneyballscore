...
const STATIC_PAGES: Array<{
  ...
  { slug: '/reviews/monthly', label: '월간 리뷰', keywords: 'reviews monthly 월간 리뷰' },
  ...
  { slug: '/lotto', label: '로또 통계 분석', keywords: 'lotto 로또 통계 분석' },
  ...
  { slug: '/lotto/check', label: '로또 조합 검증', keywords: 'lotto check 검증 조합 확인 중복' },
