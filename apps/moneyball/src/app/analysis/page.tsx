                ...
                <li key={g.gameId}>
                  ...
                  >
                    ...
                    {g.homeElo !== undefined && g.awayElo !== undefined && (() => {
                      ...
                      return (
                        <div className="flex flex-wrap items-center gap-x-2 gap-y-1 mt-2 pt-2 border-t border-gray-100 dark:border-[var(--color-border)] text-2xs font-mono tabular-nums">
