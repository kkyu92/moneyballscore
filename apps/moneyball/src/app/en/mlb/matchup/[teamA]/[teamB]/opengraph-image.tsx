...
import { FACTOR_LABELS_EN } from "@/lib/predictions/factorLabels";
  ...
  return new ImageResponse(
    (
      ...
      >
        ...
        >
          MLB Head-to-Head · AI Prediction Accuracy
        </div>
        ...
        >
          {[
            FACTOR_LABELS_EN.head_to_head,
            "Factor Compare",
            FACTOR_LABELS_EN.recent_form,
            FACTOR_LABELS_EN.park_factor,
          ].map((tag) => (
            <div
              key={tag}
              style={{
        ...
        >
          <span>
            {SITE_HOST}/en/mlb/matchup/{teamA}/{teamB}
          </span>
