...
export const alt = "MLB Matchups | MoneyBall Score";

export default function EnMlbMatchupHubTwitterImage() {
  return new ImageResponse(
    (
      ...
      >
        ...
        >
          {MLB_TEAM_COUNT} teams · {MLB_HEAD_TO_HEAD_PAIRS} head-to-head combos · AI prediction accuracy
        </div>
        ...
        >
          <span>{SITE_HOST}/en/mlb/matchup</span>
