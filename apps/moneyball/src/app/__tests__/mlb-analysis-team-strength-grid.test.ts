...
// (전량 ELO_NEUTRAL placeholder, plan #25 Elo 미구현 확정)/home_recent_form(전량 null,
// mlb-pipeline.ts 미저장) 모델 팩터 기반이라 그대로 포팅 불가 — mlb_schedule 실제 완료
// 경기 결과로 "진짜 전적"(최근 5경기 승패 + 연승/연패) 을 계산하는 대체 설계.
