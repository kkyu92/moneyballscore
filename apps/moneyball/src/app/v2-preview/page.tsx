...
import { assertSelectOk, shortTeamName, NEUTRAL_FACTOR, V2_PROMOTION_COHORT_N, INSIGHTS_LIMIT, type TeamCode, SITE_URL, DASHBOARD_ISR_SECONDS } from "@moneyball/shared";
import {
  V2_1_B_WEIGHTS,
  applyV2_1_BWeights,
  computeDelta,
