...
export function QuantOnlyBadge({ variant = 'light' }: QuantOnlyBadgeProps) {
  ...
  return (
    ...
    >
      ...
      <span
        role="tooltip"
        className="absolute left-0 top-full mt-1 z-20 hidden group-hover:block group-focus:block w-56 rounded-lg border border-amber-300 bg-white p-2 text-2xs leading-snug text-gray-700 shadow-lg dark:border-amber-700/60 dark:bg-[var(--color-surface-card)] dark:text-gray-200"
      >
