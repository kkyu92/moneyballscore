...
>(({ className, ...props }, ref) => (
  <div className={cn("absolute left-0 top-full flex justify-center")}>
    <NavigationMenuPrimitive.Viewport
      className={cn(
        "origin-top-center relative mt-1.5 h-[var(--radix-navigation-menu-viewport-height)] w-full overflow-hidden rounded-md border border-[var(--color-brand-200)] bg-[var(--color-surface-card)] text-[var(--color-brand-700)] shadow-lg data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-90 md:w-[var(--radix-navigation-menu-viewport-width)] dark:border-[var(--color-brand-800)] dark:bg-[var(--color-surface-card)] dark:text-[var(--color-brand-100)]",
        className,
      )}
      ref={ref}
      {...props}
...
>(({ className, ...props }, ref) => (
  <NavigationMenuPrimitive.Indicator
    ...
    {...props}
  >
    <div className="relative top-[60%] h-2 w-2 rotate-45 rounded-tl-sm bg-[var(--color-brand-200)] shadow-md dark:bg-[var(--color-brand-800)]" />
  </NavigationMenuPrimitive.Indicator>
));
