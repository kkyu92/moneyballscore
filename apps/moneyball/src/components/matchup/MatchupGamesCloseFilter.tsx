...
const LABELS_KO: Record<CloseFilter, string> = {
  all: '전체',
  close: '박빙만',
};

const LABELS_EN: Record<CloseFilter, string> = {
  all: 'All',
  close: 'Close only',
};

const CLOSE_GROUP_LABEL: Record<'ko' | 'en', string> = {
  ko: '접전',
  en: 'Margin',
};
...
export function MatchupGamesCloseFilter({ counts, locale = 'ko' }: Props) {
