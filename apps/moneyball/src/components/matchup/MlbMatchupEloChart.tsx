...
// KBO MatchupEloChart.tsx 병렬 구현 (plan #25 Phase 2b step 2). props shape 동일 —
// 데이터만 mlb_team_elo_history 기반 buildMlbMatchupEloTrend 산출물로 교체.
...
export function MlbMatchupEloChart({ points, teamA, teamB }: MlbMatchupEloChartProps) {
