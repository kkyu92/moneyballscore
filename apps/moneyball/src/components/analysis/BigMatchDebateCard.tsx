      ...
      <header className="mb-6">
        <div className="flex items-center gap-2 mb-1">
          ...
          >
            ...
            <span
              role="tooltip"
              className="absolute left-0 top-full mt-2 z-20 hidden group-hover:block group-focus:block bg-white dark:bg-[var(--color-surface-card)] text-gray-900 dark:text-gray-100 text-xs rounded-lg shadow-xl border border-gray-200 dark:border-[var(--color-border)] p-3 w-64"
            >
