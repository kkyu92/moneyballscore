    ...
    <section className="bg-white dark:bg-[var(--color-surface-card)] rounded-2xl border border-gray-200 dark:border-[var(--color-border)] p-6">
      ...
      {hasYesterdayPicks ? (
        <div className="grid grid-cols-2 gap-3">
          ...
          <div className="col-span-2 text-center text-xs text-gray-400 dark:text-gray-500 pt-2 border-t border-gray-100 dark:border-gray-800">
        ...
        <div className="text-center py-2">
          ...
          <p className="text-xs text-gray-400 dark:text-gray-500 mt-1">이길 수 있을까요?</p>
        </div>
      )}
    </section>
  );
