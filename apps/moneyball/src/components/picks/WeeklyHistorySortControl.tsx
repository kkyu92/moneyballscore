...
const STORAGE_SORT = 'mb_weekly_history_sort_v1';
...
export function WeeklyHistorySortControl() {
      ...
      {sort === 'asc' && (
        <style
          dangerouslySetInnerHTML={{
            __html: `[data-weekly-history-list]{display:flex;flex-direction:column-reverse;}`,
          }}
        />
      )}
