...
4. v2.0 ship 결정 시점 (n=150 또는 kill-switch fire) rollout protocol fire — `docs/research/v2.0-killswitch.md` 박제 path 정합 ← stale: v1.8 유지 확정 (cycle 1460), v2.0 ship 시점 소멸 (kill-switch NOT fired, Brier diff < 1pp)
...
- 본 결정 fire 시점 = v2.0 ship 결정 시점 전 layer. ship 결정 시점 도달 (n=150 ETA 2026-08-04) 전 PoC ship = 무용 risk → lite scope (1-pager + plan only) 강제 ← stale: n=178 도달 (cycle 1447), v1.8 유지 확정 (cycle 1460) — v2.0 ship 시점 소멸, 본 1-pager = 역사 기록
