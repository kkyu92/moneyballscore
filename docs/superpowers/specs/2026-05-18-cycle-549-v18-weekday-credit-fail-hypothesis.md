...
**Status**: spec only — 구현 보류 (사용자 review 대기 / n=150 도달 후 후속 fix-incident heavy 권장)
...
- **TODOS.md v2.0 추적**: n=150 임계 / 현재 v1.8 real-debate 10건만
...
n=150 임계까지 31건 남음. 본 spec 의 검증 step 은 그동안 데이터 누적되는 시각 (1~2주) 안 자연 추가 검증 가능.
...
- n=150 도달 (v1.8 real-debate 표본 ≥ N) 시 op-analysis heavy 에서 가중치 v2.0 확정 + 본 spec H1~H4 별 분리 측정 통합 권장
