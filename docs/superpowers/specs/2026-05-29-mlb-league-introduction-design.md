...
- **MLB 도입 = KBO 정합 risk acceptance** — 사용자 명시 결정 (2026-05-29 brainstorming)
...
- shadow_weights table 박제 (model_version='shadow-c-v{N}')
...
KST 19:00 ── mlb-combined-notify.yml
  ...
  │   format "[MLB preview] 내일 새벽 N경기 / 빅매치 ★"
...
**~55 test** 박제 (KBO 패턴 정합 — lotto-routes / silent-drift-alert / waitlist 등).
