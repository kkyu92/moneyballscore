...
- **scoring_rule 성과 (cycle 542 갱신)**: v1.5(16건,75%) / v1.6(46건,37%) / v1.7-revert(32건,53.1%) / **v1.8(25건,36.0%)** — credit-fail 15건(26.7%) + **real-debate 10건(50.0%) 첫 표본 도달** (cycle 500 = 0건). real-debate 10건 모두 주말 (Sat 5 / Sun 5). 평일 v1.8 = 100% credit-fail (Anthropic API timing 가설 점검 후보)
