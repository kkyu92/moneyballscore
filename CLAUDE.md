...
- **scoring_rule 성과 (cycle 886 갱신, 2026-05-25 측정)**: v1.5(16건,75.0%) / v1.6(46건,37.0%) / v1.7-revert(32건,53.1%) / **v1.8(39건,48.7%, Brier 0.2325)** — cycle 864 v1.8 n=32 43.8% → +7건 in 3일 = **+4.9pp 향상** (velocity 2.3/day 신규 v1.8 누적). 누적 총 n=133 (전체 48.9%). v2.0 임계 n=150 까지 17건. **velocity 가속** (cycle 864 0.22/day → cycle 886 2.3/day = 10배 가속, cycle 884 D fix 효과 + 5/22~25 정상 cron fire). **n=150 ETA 정정 (cycle 949 op-analysis lite 재측정, 2026-05-26)**: cycle 886 박제 "7~10일 (~06-04)" 산정 오류 (velocity 2.3/day × 7일 = +16 ≠ +111 부족). 실제 = (150-39)/2.8 ≈ 40일 (~07-05). 5/25 일요일 g=0 (모든 predict cron 정상 success/skip, KBO 일요일 경기 없음 정상) 으로 v1.8 cohort growth 0 (cycle 886→949 동일 n=39 유지). 5-day velocity 14/5=2.80/day (5/19+5 / 5/21+2 / 5/22+1 / 5/23+1 / 5/24+5).
