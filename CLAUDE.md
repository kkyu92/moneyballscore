...
- `apps/moneyball/src/app/glossary/page.tsx` — 15 term → 25 term (ERA / WHIP / LOB% / OBP / SLG / OPS / BABIP / Pythagorean / Brier / Calibration) + 검증·평가 신규 카테고리 (DefinedTermSet JSON-LD 자동 갱신). cycle 653 PR #942 "26 term" off-by-one drift fix (cycle 677, PR pending)
