...
- 누적 검증 99건 (n=94→99, W22 5/12~5/13 10건 포함). 전체 적중률 49.5% / Brier 0.2587. v2.0 임계 n=150 까지 51건 (cycle 378 측정).
...
- **scoring_rule 성과 (cycle 500 갱신)**: v1.5(16건,75%) / v1.6(46건,37%) / v1.7-revert(32건,53.1%) / **v1.8(15건,26.7%) — 100% credit-fail fallback (confidence=0.3 lottery 수준)**. v1.8 real-debate 표본 = 0건
- **요일별 누적 (cycle 500 갱신)**: Tue 45.0%(20) / Wed 53.8%(13) / Thu 45.8%(24) / **Fri 57.1%(21) — 최강** / Sat 52.9%(17) / **Sun 14.3%(14) — 최약, cap 0.45 적용 후 추가 누적 필요**. Thu/Fri W22~W23 추가 누적 (Thu 57.9→45.8 / Fri 68.8→57.1)
...
- CI / Cron:
  - `.github/workflows/ci.yml` (PR/push@main type-check + test, 현재 845 tests — shared 73 + kbo-data 561 + moneyball 211, cycle 223 기준)
