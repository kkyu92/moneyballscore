...
- **scoring_rule 성과 (cycle 861 갱신)**: v1.5(16건,75.0%) / v1.6(46건,37.0%) / v1.7-revert(32건,53.1%) / **v1.8(32건,43.8%, winner-centric Brier 0.4335)** — cycle 775 30건 43.3% → +2건 +0.5pp in 9일. credit-fail/real-debate 라벨별 측정 cycle 861 lite 시점 미진행 (carry-over). cycle 775 v1.8 date distribution — 05-13 5/5 real(시즌 첫날) / 05-14 0/5 credit-fail / 05-15 0/5 credit-fail / 05-16 2/5 / 05-17 1/5 / 05-19 0/5 credit-fail / cycle 861 추가 = 05-21 2건 (라벨 미측정)
