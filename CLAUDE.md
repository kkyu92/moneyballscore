...
- 누적 검증 89건 (n=76→89, W20 포함). 전체 적중률 49.4% / Brier 0.2501.
- **모델 tuning 대기 중**: head_to_head 5%→3% + 일요일 Sunday cap 0.55 → n=150 도달 후 (잔여 ~61건, 예상 4주)
...
- **Calibration 현황** (72건, cycle 207 측정): conf=0.4→54.5%, conf=0.5→41.9%, conf=0.6→53.3% (역전 구간 존재)
