...
- **v1.8 적용 완료 (cycle 335)**: head_to_head 3% + elo 10%. 일요일 Sunday cap 0.55 적용 중. 전면 v2.0 → n=150 도달 후
...
- **scoring_rule 성과 (cycle 378 갱신)**: v1.5(16건,75%) / v1.6(46건,37%) / v1.7-revert(32건,53.1%) / **v1.8(5건,60%)** — 5/13 첫 fire, 표본 부족이나 회귀 X
- **요일별 누적 (cycle 378)**: Tue 45.0%(20) / Wed 53.8%(13) / Thu 57.9%(19) / **Fri 68.8%(16) — 최강** / Sat 52.9%(17) / **Sun 14.3%(14) — 최약, cap 0.55 적용 후 추가 누적 필요**
